...
const profiles = [
  { role: 'Farmer', color: '#1a7a6e', emoji: '👨‍🌾', perks: ['Field & crop management', 'AI price forecasting', 'Quality certification', 'Sell via auction or MSP', 'Earn points & badges'] },
  { role: 'Buyer', color: '#c0533a', emoji: '🏢', perks: ['Browse certified harvests', 'Live bidding room', 'Pre-harvest contracts', 'Spot market deals', 'Manage fulfillment'] },
  { role: 'Vendor', color: '#3d5a80', emoji: '🚜', perks: ['List seeds & tools', 'Machinery rentals', 'Manage orders', 'Track payments', 'GST-verified profile'] },
  { role: 'Government', color: '#6b7c3a', emoji: '🏛️', perks: ['Issue QR certificates', 'Quality grading', 'MSP price management', 'Employee management', 'Admin dashboard'] },
];
    ...
    <div className="page home-page">
      ...
      <section className="hero">
        <div className="hero-bg">
          <div className="hero-blob" style={{ width: 600, height: 600, background: 'var(--teal)', top: -100, right: -100 }} />
          <div className="hero-blob" style={{ width: 400, height: 400, background: 'var(--rust)', bottom: -50, left: -80, animationDelay: '3s' }} />
        </div>
        ...
        <div className="hero-content">
          ...
          <h1 className="hero-title">
            One Platform for<br />
            <em>India's Entire</em><br />
            Agri Ecosystem
          </h1>
          <p className="hero-sub">
            Connecting farmers, buyers, vendors & government on a single intelligent
            platform — with AI, IoT & live markets, all in your language.
          </p>
          ...
          <div className="hero-profiles">
            {['Farmer', 'Buyer', 'Vendor', 'Govt'].map((p, i) => (
              <div key={p} className="profile-chip" style={{ animationDelay: `${i * 0.1}s` }}>
                {p}
              </div>
            ))}
          </div>
          ...
          <div className="phone-mockup">
            <div className="phone-screen">
              ...
              <div className="screen-card teal">
                ...
                <div style={{ fontSize: '0.75rem', opacity: 0.8, marginTop: 4 }}>Paddy · Harvest ready</div>
              </div>
              ...
              <div className="screen-card rust">
                ...
                <div style={{ fontSize: '0.75rem', opacity: 0.8, marginTop: 4 }}>Arhar (Tur) · 250 quintal</div>
              </div>
      ...
      <section style={{ padding: '96px 5%', background: 'var(--slate)' }}>
        <div style={{ maxWidth: 1200, margin: '0 auto' }}>
          <div className="reveal" style={{ textAlign: 'center', marginBottom: 56 }}>
            ...
            <h2 className="section-title" style={{ color: 'var(--white)' }}>4 Profiles, 1 Platform</h2>
        ...
        <div style={{ maxWidth: 1200, margin: '0 auto', display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 64, alignItems: 'center' }}>
          <div className="reveal">
            ...
            <p style={{ color: 'var(--text-light)', lineHeight: 1.8, marginBottom: 24 }}>
              AgriTech makes farming engaging through a powerful rewards system — because motivated
            ...
            <div className="game-features">
              <div className="game-item">
                ...
                <div>
                  ...
                  <p>Earn badges for quality checks, auctions, quizzes & more — displayed in your Hall of Fame.</p>
                </div>
              </div>
              <div className="game-item">
                <span>📊</span>
                <div>
                  ...
                  <p>Accumulate points across activities to level up your farmer league status.</p>
                </div>
              </div>
              <div className="game-item">
                <span>🏆</span>
                <div>
                  ...
                  <p>Compete with farmers in your district and climb the ranks.</p>
                </div>
              </div>
              <div className="game-item">
                <span>📚</span>
                <div>
                  ...
                  <p>Multilingual quizzes unlock sequentially — earn 50 pts per completed quiz.</p>
                </div>
              </div>
            </div>
          </div>
          <div className="reveal gamification-visual">
            ...
            <div className="badges-row">
              {['🏅 Knowledge Champion', '⭐ Quality Pioneer', '🔨 Auction Pro', '🌱 Soil Scientist'].map(b => (
      ...
      <section className="cta-section">
        <div className="cta-inner">
          <h2>Ready to Transform<br /><em>Indian Agriculture?</em></h2>
          <p>Join millions of farmers, buyers, and vendors on AgriTech — India's most complete agri platform.</p>
          <div className="hero-actions" style={{ justifyContent: 'center' }}>
            <Link to="/how-it-works" className="btn btn-ghost">See How It Works</Link>
            <Link to="/about" className="btn" style={{ background: 'var(--white)', color: 'var(--teal)' }}>Learn More</Link>
          </div>
        </div>
      </section>
    </div>
