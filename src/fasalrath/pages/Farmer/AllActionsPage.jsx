...
const QUICK_ACTIONS = [
  {
    ...
    path: "/fasalrath/expense-prediction",
    icon: "💹",
    bg: "#e8f5f3",
    color: "#1a7a6e",
  },
  ...
  {
    label: "Crop Guide",
    path: "/fasalrath/recommendations",
    icon: "🌱",
    bg: "#eff6ff",
    color: "#2563eb",
  },
