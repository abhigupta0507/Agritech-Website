// src/fasalrath/pages/buyer/ListingDetailsPage.jsx
...
export default function ListingDetailsPage() {
  ...
  const isWinning =
    ...
    buyer?.userId &&
    listing.highestBidder.toString() === buyer.userId.toString();
  const currentPrice =
  ...
  return (
    <div style={{ maxWidth: 800, margin: "0 auto", padding: "0 20px 40px" }}>
      ...
      <div style={{ padding: "20px 0" }}>
        ...
        >
          <div style={{ fontSize: 40, marginRight: 12 }}>👤</div>
          <div>
            <div style={{ fontSize: 18, fontWeight: 600, color: "#333" }}>
              {farmerName}
            </div>
            <div style={{ fontSize: 14, color: "#666" }}>{farmerLocation}</div>
          </div>
        </div>
        ...
        >
          ...
          <div style={{ textAlign: "center", flex: 1 }}>
            ...
            <div style={{ fontSize: 18, fontWeight: 600, color: "#E76F51" }}>
              ₹{currentPrice}
            </div>
          </div>
        </div>
          ...
          {isAuctionActive ? (
            <>
              {isWinning && (
                ...
                >
                  <span style={{ fontSize: 24, marginRight: 10 }}>🏆</span>
                  <div style={{ color: "#2A9D8F", fontWeight: "bold" }}>
                    {t("You are currently winning this auction")}
                  </div>
                </div>
              )}

              <Link to={`/fasalrath/buyer/bidding-room/${listing._id}`}>
                <button
                  style={{
                    width: "100%",
                    padding: 16,
