// src/fasalrath/pages/govt/OtpPage.jsx
...
export default function GovtOtpPage() {
  ...
  const from = location.state?.from || "/fasalrath/govt/dashboard";
  ...
  useEffect(() => {
    if (!phone) navigate("/fasalrath/govt/login", { replace: true });
  }, [phone, navigate]);
      ...
      <div className="fr-auth-card fr-slide-up">
        <div className="fr-auth-card-header">
          <div
            ...
            style={{ background: success ? "#2A9D8F" : "#606C38" }}
          >
            {success ? "✅" : "📱"}
          </div>
          ...
          {success ? (
            ...
            <form onSubmit={handleManualSubmit} noValidate>
              ...
              <button
                ...
                style={{ marginBottom: 8, background: "#606C38" }}
              >
                {loading ? (
                  <>
