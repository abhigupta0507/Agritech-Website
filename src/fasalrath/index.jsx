                        ...
                        <ProtectedRoute>
                          <PortalLayout>
                            <ComingSoonPage
                              title="Marketplace"
                              icon="🛒"
                              description="Browse seeds, fertilizers, equipment rentals from verified vendors."
                            />
                          </PortalLayout>
                        </ProtectedRoute>
                      }
                        ...
                        <ProtectedRoute>
                          <PortalLayout>
                            <ComingSoonPage
                              title="My Offers"
                              icon="🤝"
                              description="View and manage offers you've submitted to buyers on the pre-harvest marketplace."
                            />
                          </PortalLayout>
                        </ProtectedRoute>
                      }
                        ...
                        <ProtectedRoute>
                          <PortalLayout>
                            <ComingSoonPage
                              title="Orders"
                              icon="📦"
                              description="Track all your purchases and rentals from vendors."
                            />
                          </PortalLayout>
                        </ProtectedRoute>
                      }
                        ...
                        <ProtectedRoute>
                          <PortalLayout>
                            <ComingSoonPage
                              title="MSP Rates"
                              icon="📊"
                              description="View government Minimum Support Prices for your crops."
                            />
                          </PortalLayout>
                        </ProtectedRoute>
                      }
                        ...
                        <ProtectedRoute>
                          <PortalLayout>
                            <ComingSoonPage
                              title="All Features"
                              icon="⚡"
                              description="A full list of everything FasalRath can do for you."
                            />
                          </PortalLayout>
                        </ProtectedRoute>
                      }
